    ...
    objectsubject: [
        ...
        },
        {
            ...
            element: function(){
                ...
                let el = document.createElement("img");
                 el.setAttribute("id", self.id());
                el.setAttribute("src", "../../media/texture/uranusmap.jpg");
        ...
        },
        {
            ...
            element: function(){
                ...
                el.setAttribute("position", "0 3.1 2");
                el.classList.add(self.class);
                return el;
            }
        },
        {
            ...
            element: function(pointer){
                ...
                el.setAttribute("position", "0 2.5 2");
                el.classList.add(self.class);
                return el;
            }
        },
        {
            ...
            element: function(){
                ...
                el.setAttribute("position", "0 2.8 2");
                el.classList.add(self.class);
                return el;
            }
        },
        {
            ...
            element: function(){
                ...
                el.setAttribute("material", "src: #uranus-surface-texture;");
                el.setAttribute("radius", "3.98");
                el.setAttribute("position", "0 1.25 -5");
                el.setAttribute("animation", "property: rotation; to: 0 360 0; loop: true; dur: 16110; easing: linear;");
                el.classList.add(self.class);
                return el;
            }
        },
        ...
        },
        {
            ...
            element: function(){
                ...
                el.setAttribute("position", "0 1.87 4");
                el.classList.add(self.class);
                return el;
            }
        },
        {
            ...
            element: function(){
                ...
                let el = document.createElement("a-sphere");
                el.setAttribute("id", self.id());
                el.setAttribute("position", "-1 -1 4.25");
