    ...
    objectsubject: [
        ...
        },
        {
            ...
            element: function(){
                ...
                let el = document.createElement("img");
                 el.setAttribute("id", self.id());
                el.setAttribute("src", "../../media/texture/marsmap1k.jpg");
        ...
        },
        {
            ...
            element: function(){
                ...
                el.setAttribute("position", "0 3.5 -3");
                el.classList.add(self.class);
                return el;
            }
        },
        {
            ...
            element: function(pointer){
                ...
                el.setAttribute("position", "0 3 -3");
                el.classList.add(self.class);
                return el;
            }
        },
        {
            ...
            element: function(){
                ...
                el.setAttribute("position", "0 3.2 -3");
                el.classList.add(self.class);
                return el;
            }
        },
        {
            ...
            element: function(){
                ...
                el.setAttribute("material", "src: #mars-surface-texture;");
                el.setAttribute("radius", "0.53");
                el.setAttribute("position", "0 1.75 -3");
                el.setAttribute("animation", "property: rotation; to: 0 360 0; loop: true; dur: 708720; easing: linear;");
                el.classList.add(self.class);
                return el;
            }
        },
