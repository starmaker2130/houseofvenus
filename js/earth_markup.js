    ...
    objectsubject: [
        ...
        },
        {
            ...
            element: function(){
                ...
                let el = document.createElement("img");
                 el.setAttribute("id", self.id());
                el.setAttribute("src", "../../media/texture/earthmap1k.jpg");
        ...
        },
        {
            ...
            element: function(){
                ...
                el.setAttribute("id", self.id());
                el.setAttribute("rotation", "23.5 0 0");
                el.setAttribute("material", "src: #earth-surface-texture;");
                el.setAttribute("radius", "0.95");
                el.setAttribute("position", "0 1.75 -3");
                el.setAttribute("animation", "property: rotation; to: 23.5 360 0; loop: true; dur: 24000; easing: linear;");
                el.classList.add(self.class);
                return el;
            }
        },
