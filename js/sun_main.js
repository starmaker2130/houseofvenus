document.addEventListener("DOMContentLoaded", function(){
    ...
    setTimeout(function(){
        ...
        document.getElementById("planet-header-title").setAttribute("color", "orange");
        document.getElementById("planet-time-header").setAttribute("value", getCurrentTime());
        document.getElementById("planet-time-header").setAttribute("color", "orange");
        document.getElementById("planet-date-header").setAttribute("value", getCurrentDate());
        document.getElementById("planet-date-header").setAttribute("color", "orange");
