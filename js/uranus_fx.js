...
var objectData = {
    ...
    description: `Stemming from the Latin name for the primordial Greek deity personifying the sky, Uranus is the seventh planet from the Sun. Similar in composition to Neptune, both have bulk chemical compositions that differ from that of the larger gas giants Jupiter and Saturn. Uranus and Neptune are often classifed as "ice giants" to distinguish them from the former.`
}
