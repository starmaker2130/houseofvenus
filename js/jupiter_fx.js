...
var objectData = {
    ...
    description: "The fifth planet from the Sun and the largest in the Solar System, Jupiter is a gas giant known to astronomers since antiquity and named after the Roman chief deity. Jupiter lacks a well-defined solid surface and its rapid rotation shapes the planet into an oblate spheroid. The atmosphere is home to visible bands of gases that form storms -- like the Great Red Spot -- along their crossections. Jupiter is surrounded by a faint planetary ring system and a powerful magnetosphere along with 79 known moons, including the four large Galilean moons discovered by Galileo Galilei in 1610."
}
