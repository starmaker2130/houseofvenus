    ...
    objectsubject: [
        ...
        },
        {
            ...
            element: function(){
                ...
                let el = document.createElement("img");
                 el.setAttribute("id", self.id());
                el.setAttribute("src", "../../media/texture/moonmap2k.jpg");
        ...
        },
        {
            ...
            element: function(pointer){
                ...
                el.setAttribute("position", "0 2.7 -2");
                el.classList.add(self.class);
                return el;
            }
        },
        {
            ...
            element: function(){
                ...
                el.setAttribute("position", "0 2.9 -2");
                el.classList.add(self.class);
                return el;
            }
        },
        {
            ...
            element: function(){
                ...
                el.setAttribute("material", "src: #moon-surface-texture;");
                el.setAttribute("radius", "0.38");
                el.setAttribute("position", "0 2 -2");
                el.setAttribute("animation", "property: rotation; to: 0 360 0; loop: true; dur: 422256; easing: linear;");
                el.classList.add(self.class);
                return el;
            }
        },
