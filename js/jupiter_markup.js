    ...
    objectsubject: [
        ...
        },
        {
            ...
            element: function(){
                ...
                let el = document.createElement("img");
                 el.setAttribute("id", self.id());
                el.setAttribute("src", "../../media/texture/jupiter2_4k.jpg");
        ...
        },
        {
            ...
            element: function(){
                ...
                el.setAttribute("position", "0 3.5 13");
                el.classList.add(self.class);
                return el;
            }
        },
        {
            ...
            element: function(pointer){
                ...
                el.setAttribute("position", "0 3 13");
                el.classList.add(self.class);
                return el;
            }
        },
        {
            ...
            element: function(){
                ...
                el.setAttribute("position", "0 3.2 13");
                el.classList.add(self.class);
                return el;
            }
        },
        {
            ...
            element: function(){
                ...
                el.setAttribute("material", "src: #jupiter-surface-texture;");
                el.setAttribute("radius", "10.97");
                el.setAttribute("position", "0 1.25 -10");
                el.setAttribute("animation", "property: rotation; to: 0 360 0; loop: true; dur: 10543; easing: linear;");
                el.classList.add(self.class);
                return el;
            }
        },
        {
            ...
            element: function(){
                ...
                el.setAttribute("width", "5");
                el.setAttribute("position", "0 -2 11");
                el.classList.add(self.class);
                return el;
            }
        },
        {
            ...
            element: function(){
                ...
                el.setAttribute("position", "0 1.87 15");
                el.classList.add(self.class);
                return el;
            }
        },
        {
            ...
            element: function(){
                ...
                let el = document.createElement("a-sphere");
                el.setAttribute("id", self.id());
                el.setAttribute("position", "-1 -1 15.25");
        ...
        },
        {
            ...
            element: function(){
                ...
                let el = document.createElement("a-sphere");
                el.setAttribute("id", self.id());
                el.setAttribute("position", "0 -1 15");
                el.setAttribute("radius", "0.25");
