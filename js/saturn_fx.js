...
var objectData = {
    ...
    description: `The sixth planet from the Sun, a gas giant, and the second-largest in the Solar System, after Jupiter. It is a gas giant with an average radius about nine times that of Earth. Saturn is named after the Roman god of wealth and agriculture; its astronomical symbol (♄) represents the god's sickle.
Saturn has a pale yellow hue due to ammonia crystals in its upper atmosphere. Saturn also has at least 62 moons though the planet's most famous feature by far is its prominent ring system composed primarily of ice particles.`
};
