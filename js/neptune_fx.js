...
var objectData = {
    ...
    description: `The eighth and farthest known planet from the Sun in the Solar System, Neptune is named after the Roman god of the sea. Neptune is not visible to the unaided eye and is the only planet in the Solar System initially discovered via mathematical prediction rather than by empirical observation. An
    "ice giant", alongside Uranus, it it is one of the coldest places in the Solar System with water, ice, rock, ammonia, and methane all found on the planet. It also has 13 moons, the largest of which is Triton.`
}
