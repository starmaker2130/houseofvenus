...
var objectData = {
    ...
    description: `A terrestial planet named after the Roman goddess of love and beauty. Venus is the second planet from the Sun and is referred to as Earth's "sister" due to their similar size and bulk composition. Being the brightest natural object in the night sky after the Moon, Venus casts shadows and is occasionally visible during broad daylight, setting in the west just after dusk and rising in the east a bit before dawn.`
}
