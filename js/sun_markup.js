    ...
    objectsubject: [
        ...
        },
        {
            ...
            element: function(){
                ...
                let el = document.createElement("img");
                 el.setAttribute("id", self.id());
                el.setAttribute("src", "../../media/texture/sunmap.jpg");
        ...
        },
        {
            ...
            element: function(){
                ...
                el.setAttribute("position", "0 3.5 23");
                el.classList.add(self.class);
                return el;
            }
        },
        {
            ...
            element: function(pointer){
                ...
                el.setAttribute("position", "0 3 23");
                el.classList.add(self.class);
                return el;
            }
        },
        {
            ...
            element: function(){
                ...
                el.setAttribute("position", "0 3.2 23");
                el.classList.add(self.class);
                return el;
            }
        },
        {
            ...
            element: function(){
                ...
                el.setAttribute("material", "src: #sun-surface-texture;");
                el.setAttribute("radius", "0.95");
                el.setAttribute("position", "0 1.75 -10");
                el.setAttribute("animation", "property: rotation; to: 0 360 0; loop: true; dur: 60000; easing: linear;");
                el.classList.add(self.class);
                return el;
            }
        },
        ...
        },
        {
            ...
            element: function(){
                ...
                el.setAttribute("position", "0 1.87 0");
                el.classList.add(self.class);
                return el;
            }
        },
        {
            ...
            element: function(){
                ...
                let el = document.createElement("a-sphere");
                el.setAttribute("id", self.id());
                el.setAttribute("position", "-1 -1 0.25");
