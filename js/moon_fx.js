...
var objectData = {
    ...
    description: `The Earth's only permanent natural satellite and the largest among planetary satellites relative to its primary. Thought to have formed about 4.51 billion years ago, not long after Earth, the most widely accepted explanation is that the Moon formed from the debris left over after a giant impact between Earth and a Mars-sized body called Theia. New research of moon rocks, although not rejecting the Theia hypothesis, suggests that the moon may be older than previously thought. Its gravitational influence produces the ocean tides, body tides, and the slight lengthening of the day.`
}
