    ...
    objectsubject: [
        ...
        },
        {
            ...
            element: function(){
                ...
                let el = document.createElement("img");
                 el.setAttribute("id", self.id());
                el.setAttribute("src", "../../media/texture/mercurymap.jpg");
        ...
        },
        {
            ...
            element: function(){
                ...
                el.setAttribute("material", "src: #mercury-surface-texture;");
                el.setAttribute("radius", "0.38");
                el.setAttribute("position", "0 1.75 -2");
